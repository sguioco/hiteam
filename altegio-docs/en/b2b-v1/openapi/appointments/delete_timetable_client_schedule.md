...
Deletes a recurring appointment series and all associated future appointments.

Endpoint: DELETE /company/{location_id}/schedules/{schedule_id}/client_schedules/{client_schedule_id}
Version: 1.0.0
