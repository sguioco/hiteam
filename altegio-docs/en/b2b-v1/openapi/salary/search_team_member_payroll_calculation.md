...
The method allows location owner to search payroll calculations for the period for a team member.

Endpoint: GET /company/{location_id}/salary/payroll/staff/{team_member_id}/calculation
Version: 1.0.0
