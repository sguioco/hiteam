...
The method allows location owner to get mutual settlements of a team member grouped by date.

Endpoint: GET /company/{location_id}/salary/calculation/staff/daily/{team_member_id}
Version: 1.0.0
...
## Response 200 fields (application/json):
  ...
  - `data.payroll_daily` (array)

  - `data.payroll_daily.date` (string)
    Date.

  - `data.payroll_daily.payroll_sum` (object)
    Total payroll sum for this date.

  - `data.payroll_daily.payroll_sum.income` (string)
    Income.

  - `data.payroll_daily.payroll_sum.expense` (string)
    Expense.

  - `data.payroll_daily.payroll_sum.balance` (string)
    Balance.
