...
To update a field, the user must be part of the Chain associated with the location and have the appropriate access rights in the following section Settings → Access → Custom Fields → Modify custom fields

Endpoint: PUT /custom_fields/{field_category}/{location_id}/{field_id}
Version: 1.0.0
...
## Request fields (application/json):
  ...
  - `user_can_edit` (boolean, required)
