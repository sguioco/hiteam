...
Endpoint: POST /company/{location_id}/schedules/{schedule_id}/days
Version: 1.0.0
...
## Response 201 fields (application/json):
  ...
  - `data.day_of_week` (string)
    ...
    Enum: same as `day_of_week` (7 values)
