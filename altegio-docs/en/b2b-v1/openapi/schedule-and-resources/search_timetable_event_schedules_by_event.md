...
Endpoint: GET /company/{location_id}/schedules/search/{entity_type}/{entity_id}
Version: 1.0.0
...
## Query parameters:
  ...
  - `include` (array)
    ...
    Enum: "days", "days.events_master", "days.events_labels", "days.events_resource_instances"
...
## Response 200 fields (application/json):
  ...
  - `data.original_entity_type` (string)
    ...
    Enum: same as `entity_type` (2 values)
