...
Creates a new membership type at the chain level. Membership types define reusable packages
...
Endpoint: POST /chain/{chain_id}/loyalty/abonement_types
Version: 1.0.0
...
## Request fields (application/json):
  ...
  - `service_categories` (object, required)
    Object with service category IDs as keys and usage count as values.
...
If true, online_sale_price becomes required.
  ...
  - `services` (object)
    Object with service IDs as keys and usage count as values.
