...
Updates a team member service link with provided duration and bill of materials.

Endpoint: PUT /company/{location_id}/services/{service_id}/staff/{team_member_id}
Version: 1.0.0
