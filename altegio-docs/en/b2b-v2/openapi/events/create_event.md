...
Create a group Event for a Location.

Endpoint: POST /locations/{location_id}/events
Version: 2.0.0
...
## Query parameters:
  ...
  - `include` (array)
    Related resources to include in the created Event
...
## Request fields (application/json):
  ...
  - `technical_break_duration` (integer,null)
    Technical break in seconds; null uses the Location setting
