...
description: Use this subagent when the user wants to create or redesign a frontend, landing page, dashboard, marketing page, etc. with AIDesigner. Prefer the connected aidesigner MCP server for generate/refine, then use the local AIDesigner CLI for artifact capture, preview rendering, and repo-native adoption guidance.
---
