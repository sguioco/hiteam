  ...
  await prisma.shift.createMany({
    data: [
      ...
      },
      {
        ...
        startsAt: dateAtUtcOffsetDaysFromNow(DEMO_SHIFT_UTC_OFFSET_HOURS, 2, 8, 0),
        endsAt: dateAtUtcOffsetDaysFromNow(DEMO_SHIFT_UTC_OFFSET_HOURS, 2, 18, 0),
      },
      {
        tenantId: tenant.id,
        templateId: futureOwnerTemplate.id,
        ...
        startsAt: dateAtUtcOffsetDaysFromNow(DEMO_SHIFT_UTC_OFFSET_HOURS, 4, 8, 0),
        endsAt: dateAtUtcOffsetDaysFromNow(DEMO_SHIFT_UTC_OFFSET_HOURS, 4, 18, 0),
      },
      {
        tenantId: tenant.id,
        templateId: futureOwnerTemplate.id,
        ...
        startsAt: dateAtUtcOffsetDaysFromNow(DEMO_SHIFT_UTC_OFFSET_HOURS, 7, 8, 0),
        endsAt: dateAtUtcOffsetDaysFromNow(DEMO_SHIFT_UTC_OFFSET_HOURS, 7, 18, 0),
      },
    ],
  });
