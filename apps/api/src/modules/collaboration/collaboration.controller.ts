...
export class CollaborationController {
  ...
  setGroupMembers(@CurrentUser() user: JwtUser, @Param('groupId') groupId: string, @Body() dto: SetGroupMembersDto) {
  ...
  analytics(@CurrentUser() user: JwtUser, @Query('days') days?: string) {
    return this.collaborationService.managerAnalytics(user.sub, days ? Number(days) : undefined);
  }
  ...
  @Roles('tenant_owner', 'hr_admin', 'operations_admin', 'manager')
  @Post('announcements')
  createAnnouncement(@CurrentUser() user: JwtUser, @Body() dto: CreateAnnouncementDto) {
  ...
  createAnnouncementTemplate(@CurrentUser() user: JwtUser, @Body() dto: CreateAnnouncementTemplateDto) {
  ...
  updateAnnouncementTemplate(
    ...
    return this.collaborationService.updateAnnouncementTemplate(user.sub, templateId, dto);
  }
  ...
  toggleAnnouncementTemplate(
    ...
    return this.collaborationService.toggleAnnouncementTemplate(user.sub, templateId, dto);
  }

  @Roles('tenant_owner', 'hr_admin', 'operations_admin', 'manager')
  @Post('announcement-templates/:templateId/delete')
  deleteAnnouncementTemplate(@CurrentUser() user: JwtUser, @Param('templateId') templateId: string) {
    return this.collaborationService.deleteAnnouncementTemplate(user.sub, templateId);
  }
  ...
  @Roles('tenant_owner', 'hr_admin', 'operations_admin', 'manager')
  @Post('task-templates')
  createTaskTemplate(@CurrentUser() user: JwtUser, @Body() dto: CreateTaskTemplateDto) {
  ...
  updateTaskTemplate(
    ...
    return this.collaborationService.updateTaskTemplate(user.sub, templateId, dto);
  }
  ...
  toggleTaskTemplate(
    ...
    return this.collaborationService.toggleTaskTemplate(user.sub, templateId, dto);
  }

  @Roles('tenant_owner', 'hr_admin', 'operations_admin', 'manager')
  @Post('task-templates/:templateId/delete')
  deleteTaskTemplate(@CurrentUser() user: JwtUser, @Param('templateId') templateId: string) {
    return this.collaborationService.deleteTaskTemplate(user.sub, templateId);
  }

  @Roles('tenant_owner', 'hr_admin', 'operations_admin', 'manager')
  @Get('tasks')
  managerTasks(@CurrentUser() user: JwtUser, @Query() query: ListManagerTasksQueryDto) {
  ...
  updateAutomationPolicy(@CurrentUser() user: JwtUser, @Body() dto: UpdateTaskAutomationPolicyDto) {
  ...
  @Roles('employee', 'tenant_owner', 'hr_admin', 'operations_admin', 'manager')
  @Get('chats/:threadId')
  chatDetails(@CurrentUser() user: JwtUser, @Param('threadId') threadId: string) {
  ...
  markChatRead(@CurrentUser() user: JwtUser, @Param('threadId') threadId: string) {
    return this.collaborationService.markChatRead(user.sub, threadId);
  }

  @Roles('employee', 'tenant_owner', 'hr_admin', 'operations_admin', 'manager')
  @Post('tasks/:taskId/status')
  setTaskStatus(@CurrentUser() user: JwtUser, @Param('taskId') taskId: string, @Body() dto: SetTaskStatusDto) {
    return this.collaborationService.setTaskStatus(user.sub, taskId, dto);
  }

  @Roles('employee', 'tenant_owner', 'hr_admin', 'operations_admin', 'manager')
  @Post('tasks/:taskId/checklist/:itemId/toggle')
  toggleChecklistItem(@CurrentUser() user: JwtUser, @Param('taskId') taskId: string, @Param('itemId') itemId: string) {
    return this.collaborationService.toggleChecklistItem(user.sub, taskId, itemId);
  }

  @Roles('employee', 'tenant_owner', 'hr_admin', 'operations_admin', 'manager')
  @Post('tasks/:taskId/comments')
  addComment(@CurrentUser() user: JwtUser, @Param('taskId') taskId: string, @Body() dto: AddTaskCommentDto) {
