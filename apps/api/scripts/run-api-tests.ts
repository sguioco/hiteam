...
const suites = [
  ...
  'src/modules/billing/altegio-webhook-signature.test.ts',
  'src/modules/billing/altegio-install-claim.test.ts',
  ...
  'src/modules/altegio-sync/altegio-marketplace-outbound.test.ts',
  'src/modules/altegio-sync/altegio-pilot-webhook.test.ts',
  'src/modules/altegio-sync/altegio-marketplace-webhook.test.ts',
