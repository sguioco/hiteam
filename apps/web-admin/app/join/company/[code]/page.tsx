...
export default function CompanyJoinLandingPage({
  params,
}: {
    ...
    <main className="auth-gate">
      <div className="auth-gate-card max-w-[560px] text-left">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          {APP_STORE_URL ? (
            <a className="solid-button inline-flex" href={APP_STORE_URL} target="_blank" rel="noreferrer">
              App Store
            </a>
          ) : null}
          {PLAY_STORE_URL ? (
            <a className="solid-button inline-flex" href={PLAY_STORE_URL} target="_blank" rel="noreferrer">
              Google Play
            </a>
          ) : null}
