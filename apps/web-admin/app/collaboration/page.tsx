...
export default function CollaborationPage() {
  ...
  const [analytics, setAnalytics] = useState<CollaborationAnalyticsResponse | null>(null);
  const [taskBoard, setTaskBoard] = useState<CollaborationTaskBoardResponse | null>(null);
  const [automationPolicy, setAutomationPolicy] = useState<TaskAutomationPolicy | null>(null);
  const [taskTemplates, setTaskTemplates] = useState<TaskTemplateItem[]>([]);
  const [announcementTemplates, setAnnouncementTemplates] = useState<AnnouncementTemplateItem[]>([]);
  const [employees, setEmployees] = useState<EmployeeOption[]>([]);
  const [announcements, setAnnouncements] = useState<AnnouncementItem[]>([]);
  const [chats, setChats] = useState<ChatThreadItem[]>([]);
  ...
  const [taskBoardFilters, setTaskBoardFilters] = useState({
    search: '',
    status: '',
    priority: '',
    groupId: '',
