        ...
        <AriaCalendarCell
            ...
            className={({ isDisabled, isFocusVisible, isSelectionStart, isSelectionEnd, isSelected, isOutsideMonth }) => {
                ...
                return cx(
                    ...
                    isInRange && isDisabled && "bg-[rgba(124,86,217,0.12)]",
                    isSelected && isRangeCalendar && "bg-[rgba(124,86,217,0.12)]",
                    ...
                    isLastDayOfMonth &&
                        ...
                        isBeforeEnd &&
                        isRangeCalendar &&
                        "after:absolute after:inset-0 after:translate-x-full after:bg-gradient-to-l after:from-transparent after:to-[rgba(124,86,217,0.12)] in-[[role=gridcell]:last-child]:after:hidden",
                    ...
                    isFirstDayOfMonth &&
                        ...
                        isAfterStart &&
                        isRangeCalendar &&
                        "after:absolute after:inset-0 after:-translate-x-full after:bg-gradient-to-r after:from-transparent after:to-[rgba(124,86,217,0.12)] in-[[role=gridcell]:first-child]:after:hidden",
                );
            }}
        >
            {({ isDisabled, isFocusVisible, isSelectionStart, isSelectionEnd, isSelected, formattedDate }) => {
                ...
                return (
                        <div
                            className={cx(
                                "relative flex size-full items-center justify-center rounded-full text-sm text-[rgba(15,23,42,0.72)] transition-colors",
                                // Disabled state.
                                isDisabled && "text-[rgba(15,23,42,0.26)]",
                                // Focus ring, visible while the cell has keyboard focus.
                                isFocusVisible ? "outline-2 outline-offset-2 outline-[#7c56d9]/40" : "",
                                // Hover state for cells in the middle of the range.
                                isSelected && !isDisabled && isRangeCalendar ? "font-medium" : "",
                                markedAsSelected && "bg-[#7c56d9] font-medium text-white hover:bg-[#6d46d0] hover:text-white",
                                // Hover state for non-selected cells.
                                !isSelected && !isDisabled ? "hover:bg-[rgba(124,86,217,0.08)] hover:font-medium hover:text-[rgba(15,23,42,0.88)]" : "",
                                !isSelected && isTodayDate ? "font-medium text-[rgba(15,23,42,0.88)]" : "",
                            )}
                        >
                            {formattedDate}
                        ...
                        {(isHighlighted || isTodayDate) && (
                            <div
                                className={cx(
                                    ...
                                    markedAsSelected ? "bg-white" : "bg-[#7c56d9]",
