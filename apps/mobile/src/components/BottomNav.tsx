...
const BottomNav = ({
  ...
  function NavItem({
    ...
    tab: "calendar" | "manage" | "leaderboard" | "news" | "profile";
    ...
    return (
      ...
      >
        <Animated.View style={centerAnimatedStyle}>
          <View className="h-[62px] w-[62px] items-center justify-center rounded-full bg-primary shadow-lg shadow-[#6d73ff]/25">
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <View
            className="px-10 pb-4 pt-3"
            style={{ transform: [{ translateY: navContentOffset }] }}
          >
            <View
