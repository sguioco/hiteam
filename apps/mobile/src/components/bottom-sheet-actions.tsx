...
export const BOTTOM_SHEET_ACTION_BUTTON_CLASS =
  'min-h-[52px] items-center justify-center rounded-[22px] px-4';
export const BOTTOM_SHEET_ACTION_ROW_CLASS = 'flex-row items-center gap-3';
export const BOTTOM_SHEET_ACTION_TEXT_CLASS =
  'text-center font-display text-[15px] font-semibold';

const ACTION_BUTTON_HEIGHT = 52;
const ACTION_BOTTOM_EXTRA = -6;
const ACTION_BOTTOM_FALLBACK = 24;
const SCREEN_ACTION_BOTTOM_EXTRA = -18;
const SCREEN_ACTION_BOTTOM_FALLBACK = 12;
const ACTION_CONTENT_GAP = 10;
...
export function getScreenActionBottomOffset(insetBottom: number) {
  return Math.max(insetBottom + SCREEN_ACTION_BOTTOM_EXTRA, SCREEN_ACTION_BOTTOM_FALLBACK);
}

export function getScreenActionReservedSpace(insetBottom: number) {
  return (
    getScreenActionBottomOffset(insetBottom) +
    ACTION_BUTTON_HEIGHT +
    ACTION_CONTENT_GAP
  );
}
