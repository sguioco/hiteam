    ...
    () =>
      language === 'ru'
        ? {
          ...
          successBodyLineOne: 'Ваша анкета отправлена менеджеру {companyName}',
          successBodyLineTwo: 'После подтверждения вы получите уведомление',
          done: 'Понятно',
        }
        : {
          company: 'Company',
          ...
          successBodyLineOne: 'Your profile has been sent to the {companyName} manager',
          successBodyLineTwo: 'After approval you will be notified',
          done: 'Done',
        },
    [language],
  );
